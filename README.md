...
| `ApplicationHeader` and `ApplicationHeaderResponse` | renderer-neutral | persistent application identity followed by the shared Help and Settings actuators above a control surface | application name, placement of that control surface, settings condition, and product-specific witnesses |
