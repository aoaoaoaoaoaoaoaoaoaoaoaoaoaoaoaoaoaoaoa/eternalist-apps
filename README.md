...
| `ApplicationPaths` | native | the config, data, local data, cache, state, and runtime directories derived from a product identity, and their creation | every file and subdirectory beneath them |
